/* ==========================================================================
  ...
  function decorationMarkup(decor) {
    ...
    if (decor.type === 'cottage') {
      ...
      if (curStyleId === 'cottage_lv1') {
        // Lv.1 避风港原木屋 (Cozy Woodland Cottage) - 3X Grand Detail
        architecturalDetails = `
          <!-- 3D 石砌大烟囱与袅袅炊烟 -->
          <div class="chimney-complex">
            <i class="chimney-brick"></i>
            <i class="chimney-cap"></i>
            <i class="smoke s1"></i>
            <i class="smoke s2"></i>
            <i class="smoke s3"></i>
          </div>
          ...
          <!-- 双层重叠暖红坡屋顶与阁楼老虎窗 -->
          <div class="roof-main">
            <i class="roof-tiles"></i>
            <i class="roof-ridge-cap"></i>
            <div class="dormer">
              <i class="dormer-roof"></i>
              <div class="dormer-window">
                <i class="dormer-pane"></i>
              </div>
            </div>
            <i class="roof-eaves"></i>
          </div>

          <!-- 主屋体与原木横纹立面 -->
          <div class="house-structure">
            <div class="house-wall">
              <div class="wall-timber-stripes"></div>
              <!-- 门廊与入户大门 -->
              <div class="porch-area">
                <i class="porch-roof"></i>
                <i class="porch-pillar p-left"></i>
                <i class="porch-pillar p-right"></i>
                <div class="door-frame">
                  <i class="door-panel"></i>
                  <i class="door-window"></i>
                  <i class="door-knob"></i>
                </div>
                <i class="porch-light"></i>
              </div>
              <!-- 双联暖黄明亮格子窗 -->
              <div class="window-group">
                <div class="window w-left">
                  <i class="curtain c-left"></i>
                  <i class="curtain c-right"></i>
                  <i class="mullion-h"></i>
                  <i class="mullion-v"></i>
                </div>
                <div class="window w-right">
                  <i class="curtain c-left"></i>
                  <i class="curtain c-right"></i>
                  <i class="mullion-h"></i>
                  <i class="mullion-v"></i>
              ...
              <!-- 窗台繁花木质花箱 -->
              <div class="flower-box fb-left"><i>🌸</i><i>🌼</i><i>🌿</i></div>
              <div class="flower-box fb-right"><i>🌺</i><i>🌸</i><i>🌿</i></div>
              <!-- 木质招牌 -->
              <div class="house-signboard">✦ PAPA & PUMPKIN ✦</div>
            </div>
            <!-- 石砌台基与阶梯 -->
            <div class="stone-foundation">
              <i class="step-1"></i>
              <i class="step-2"></i>
              <span class="welcome-mat">WELCOME</span>
            </div>
          </div>
        `;
      } else if (curStyleId === 'cottage_lv2') {
        // Lv.2 晴空风车庄园 (Windmill Homestead) - 3X Grand Detail
        architecturalDetails = `
          <!-- 荷兰八角风车石塔楼 -->
          <div class="windmill-tower">
            <i class="tower-roof"></i>
            <div class="weather-vane"><i>🐓</i></div>
            <!-- 3D 旋转风车四叶大风帆 -->
            <div class="windmill-hub">
              <div class="windmill-sails">
                <div class="sail-arm sa1"><i class="sail-lattice"></i><i class="sail-cloth"></i></div>
                <div class="sail-arm sa2"><i class="sail-lattice"></i><i class="sail-cloth"></i></div>
                <div class="sail-arm sa3"><i class="sail-lattice"></i><i class="sail-cloth"></i></div>
                <div class="sail-arm sa4"><i class="sail-lattice"></i><i class="sail-cloth"></i></div>
                <i class="hub-center"></i>
              </div>
            </div>
            <!-- 观景露台与木栏杆 -->
            <div class="observation-balcony">
              <i class="balcony-fence"></i>
            </div>
            <div class="tower-body">
              <i class="tower-window tw1"></i>
              <i class="tower-window tw2"></i>
              <i class="tower-door"></i>
            </div>
          </div>
          <!-- 庄园副楼谷仓与丰收金麦 -->
          <div class="farm-annex">
            <i class="annex-roof"></i>
            <i class="annex-wall"></i>
            <i class="annex-door"></i>
            <div class="wheat-sheaves"><i>🌾</i><i>🌾</i><i>🌻</i><i>🌾</i></div>
          </div>
          <div class="stone-foundation windmill-base">
            <i class="step-1"></i>
            <i class="step-2"></i>
          </div>
        `;
      } else if (curStyleId === 'cottage_lv3') {
        // Lv.3 樱落和风茶庵 (Sakura Zen Teahouse) - 3X Grand Detail
        architecturalDetails = `
          <!-- 三重翘角飞檐黛瓦屋顶 -->
          <div class="pagoda-roof-tier-3">
            <i class="roof-ridge"></i>
            <i class="roof-eave-tip tip-left"></i>
            <i class="roof-eave-tip tip-right"></i>
          </div>
          <div class="pagoda-roof-tier-2">
            <i class="roof-ridge"></i>
            <i class="roof-eave-tip tip-left"></i>
            <i class="roof-eave-tip tip-right"></i>
          </div>
          <div class="pagoda-roof-tier-1">
            <i class="roof-ridge"></i>
            <i class="roof-eave-tip tip-left"></i>
            <i class="roof-eave-tip tip-right"></i>
          </div>
          ...
          <!-- 和风主体与朱红回廊 -->
          <div class="teahouse-body">
            <!-- 摇曳纸灯笼 -->
            <div class="hanging-lanterns">
              <i class="lantern l1">🏮</i>
              <i class="lantern l2">🏮</i>
            </div>
            <!-- 和风障子拉门与木格窗 -->
            <div class="shoji-screens">
              <div class="shoji-door sd-left"><i class="grid"></i></div>
              <div class="shoji-door sd-right"><i class="grid"></i></div>
              <div class="shoji-window sw-left"><i class="grid"></i></div>
              <div class="shoji-window sw-right"><i class="grid"></i></div>
            </div>
            <!-- 朱红回廊与栏杆 -->
            <div class="veranda-deck">
              <i class="veranda-railing"></i>
              <i class="veranda-pillar vp1"></i>
              <i class="veranda-pillar vp2"></i>
              <i class="veranda-pillar vp3"></i>
            </div>
          </div>

          <!-- 多图层随风飘落樱花雨 -->
          <div class="sakura-storm">
            <i class="sakura-petal sp1">🌸</i>
            <i class="sakura-petal sp2">🌸</i>
            <i class="sakura-petal sp3">🌸</i>
            <i class="sakura-petal sp4">🌸</i>
            <i class="sakura-petal sp5">🌸</i>
            <i class="sakura-petal sp6">🌸</i>
          </div>

          <!-- 庭院石灯笼与竹水景 -->
          <div class="zen-garden-acc">
            <i class="stone-toro">🏮</i>
            <i class="bamboo-spout">🎍</i>
          </div>
        `;
      } else if (curStyleId === 'cottage_lv4') {
        // Lv.4 碧琉璃水上行宫 (Azure Crystal Palace) - 3X Grand Detail
        architecturalDetails = `
          <!-- 晶蓝琉璃尖顶与悬浮魔晶宝石 -->
          <div class="crystal-spire">
            <i class="spire-finial"></i>
            <i class="floating-gem g1">💎</i>
            <i class="floating-gem g2">💎</i>
            <i class="floating-gem g3">💎</i>
          </div>
          <div class="crystal-roof-dome">
            <i class="dome-crest"></i>
            <div class="dome-facets"></div>
          </div>

          <!-- 宫殿主体与贝母水晶立柱 -->
          <div class="palace-structure">
            <div class="crystal-pillars">
              <i class="crystal-col c1"></i>
              <i class="crystal-col c2"></i>
              <i class="crystal-col c3"></i>
              <i class="crystal-col c4"></i>
            </div>
            <div class="stained-glass-windows">
              <i class="sg-window sg1"></i>
              <i class="sg-window sg2"></i>
              <div class="palace-arch-portal">
                <i class="portal-gate"></i>
              </div>
            </div>
          </div>

          <!-- 月泉波光底座与琉璃水台 -->
          <div class="crystal-moat-basin">
            <div class="water-ripples"></div>
            <i class="palace-steps"></i>
          </div>

          <!-- 环绕水雾流光与升腾星芒 -->
          <div class="crystal-sparkles">
            <i class="crystal-sparkle cs1">✦</i>
            <i class="crystal-sparkle cs2">✦</i>
            <i class="crystal-sparkle cs3">✦</i>
            <i class="crystal-sparkle cs4">✦</i>
            <i class="crystal-sparkle cs5">✦</i>
          </div>
        `;
      } else if (curStyleId === 'cottage_lv5') {
        // Lv.5 蓬莱仙阁浮云殿 (Celestial Cloud Sanctuary) - 3X Grand Detail
        architecturalDetails = `
          <!-- 圣域神圣旋转金光轮 -->
          <div class="divine-celestial-halo"></div>

          <!-- 纯金双重重檐龙脊殿顶 -->
          <div class="celestial-roof-top">
            <i class="golden-orb"></i>
            <i class="roof-dragon-eave de-left"></i>
            <i class="roof-dragon-eave de-right"></i>
          </div>
          <div class="celestial-roof-lower">
            <i class="roof-dragon-eave de-left"></i>
            <i class="roof-dragon-eave de-right"></i>
          </div>

          <!-- 金阙大殿、朱漆金柱与汉白玉栏杆 -->
          <div class="celestial-palace-body">
            <div class="imperial-vermilion-columns">
              <i class="column col1"></i>
              <i class="column col2"></i>
              <i class="column col3"></i>
              <i class="column col4"></i>
            </div>
            <div class="imperial-golden-doors">
              <i class="gold-door gd1"></i>
              <i class="gold-door gd2"></i>
              <i class="gold-plaque">✦ 蓬莱仙阙 ✦</i>
            </div>
            <div class="white-jade-balustrade">
              <i class="jade-rail"></i>
              <i class="jade-post jp1"></i>
              <i class="jade-post jp2"></i>
              <i class="jade-post jp3"></i>
              <i class="jade-steps"></i>
            </div>
          </div>

          <!-- 缭绕九天祥云海底座 -->
          <div class="celestial-cloud-sea">
            <i class="cloud-puff cp1">☁️</i>
            <i class="cloud-puff cp2">☁️</i>
            <i class="cloud-puff cp3">☁️</i>
            <i class="cloud-puff cp4">☁️</i>
          </div>
          <!-- 环绕漫天星宿金光 -->
          <div class="celestial-floating-stars">
            <i class="c-star s1">✨</i>
            <i class="c-star s2">✨</i>
            <i class="c-star s3">✨</i>
            <i class="c-star s4">✨</i>
